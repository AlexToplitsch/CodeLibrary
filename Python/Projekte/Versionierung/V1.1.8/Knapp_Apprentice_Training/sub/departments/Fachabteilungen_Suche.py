...
class Fachabteilungen_Suche(QDialog, Ui_Dialog):
    ...
    def on_twAnzeige_suche_cellClicked(self, row, column):
        ...
        self.parent().leAbteilungsleiteremail.setText(self.twAnzeige_suche.item(row, 5).text())
        self.parent().leAbteilungsleitertel.setText(self.twAnzeige_suche.item(row, 6).text())
        self.parent().leAnsprechspersonname.setText(self.twAnzeige_suche.item(row, 7).text())
        self.parent().leAnsprechspersonemail.setText(self.twAnzeige_suche.item(row, 8).text())
        self.parent().leAnsprechspersontel.setText(self.twAnzeige_suche.item(row, 9).text())
        self.parent().leAnsprechspersonname.setText(self.twAnzeige_suche.item(row, 10).text())
        pass
