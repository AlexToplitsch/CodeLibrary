...
class Lehrstoff_Suche(QDialog, Ui_Lehrstoff_Suche):
    ...
    def tW_Lehrstoff_DB_Anzeigen(self, f1 = ""):
        ...
        if f1 != "":
            sql = "select Ausbildungsthema,Lehrstoff_ID,Hauptthema,Lehrstoff,Verantwortlicher,Dokument,Stunden,Hilfsmittel,LAPThemenID,Benutzer,`Änderung` from kat_lehrstoff where concat(Ausbildungsthema, Lehrstoff_ID, Hauptthema, Lehrstoff, Verantwortlicher, Dokument) like '"+ '%' + f1 + '%' "'"
        else:
            sql = "select Ausbildungsthema,Lehrstoff_ID,Hauptthema,Lehrstoff,Verantwortlicher,Dokument,Stunden,Hilfsmittel,LAPThemenID,Benutzer,`Änderung` from kat_lehrstoff"
