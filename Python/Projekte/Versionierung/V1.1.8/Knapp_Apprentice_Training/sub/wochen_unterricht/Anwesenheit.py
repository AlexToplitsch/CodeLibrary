...
# 
    ...
    def on_tableWidget_cellClicked(self, row, column):
        ...
        if self.tableWidget.item(row, 1).checkState() == Qt.Checked:
            ...
            sql = "UPDATE kat_anwesenheit_abwesenheit set Name=%s, Abwesend=%s" + " WHERE ID_Woche = '" +self.parent().parent().label_jahr.text()+self.parent().parent().te_KW.text()+"-"+str(spalte)+"-"+self.parent().Row.text()+"' and Name='"+self.lineEdit_Vorname.text()+" "+self.lineEdit_Nachname.text()+"'" 
            print(sql)
        ...
        if self.tableWidget.item(row, 1).checkState() == Qt.Unchecked:
            ...
            sql = "UPDATE kat_anwesenheit_abwesenheit set Abwesend=%s, Name=%s" + " WHERE ID_Woche = '" +self.parent().parent().label_jahr.text()+self.parent().parent().te_KW.text()+"-"+str(spalte)+"-"+self.parent().Row.text()+"' and Name='"+self.lineEdit_Vorname.text()+" "+self.lineEdit_Nachname.text()+"'" 
            print(sql)
