...
class LAP_Themenkatalog_Suche(QDialog, Ui_LAP_Themenkatalog_Suche):
    ...
    def on_tW_LAP_Themenkatalog_DB_cellClicked(self, row, column):
        ...
        """
        try:
            self.parent().cB_Fachrichtung.setCurrentText(self.tW_LAP_Themenkatalog_DB.item(row, 0).text())
            self.parent().le_Themen_ID.setText(self.tW_LAP_Themenkatalog_DB.item(row, 1).text())
            self.parent().le_Hauptthema.setText(self.tW_LAP_Themenkatalog_DB.item(row, 2).text())
            self.parent().le_Thema.setText(self.tW_LAP_Themenkatalog_DB.item(row, 3).text())
            self.parent().cB_Ausbilder.setCurrentText(self.tW_LAP_Themenkatalog_DB.item(row, 4).text())
            self.parent().sB_Lehrjahr.setValue(int(self.tW_LAP_Themenkatalog_DB.item(row, 5).text()))
            self.parent().sB_BS_Jahr.setValue(int(self.tW_LAP_Themenkatalog_DB.item(row, 6).text()))
        except Exception:
