...
class LAP_Themenkatalog_Suche(QDialog, Ui_LAP_Themenkatalog_Suche):
    ...
    def tW_LAP_Themenkatalog_DB_Anzeigen(self, f1 = ""):
        ...
        self.tW_LAP_Themenkatalog_DB.setColumnCount(10)
        ...
        self.tW_LAP_Themenkatalog_DB.setHorizontalHeaderItem(9, colname)
        ...
        if f1 != "":
           sql = "select * from kat_lap_themenkatalog where concat(Fachrichtung, Themen_ID, Hauptthema, Thema, Ausbilder) like '"+ '%' + f1 + '%' "'"
        else:
            sql = "select * from KAT_lap_themenkatalog"
