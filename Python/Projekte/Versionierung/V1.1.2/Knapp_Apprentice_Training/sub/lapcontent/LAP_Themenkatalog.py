...
class Themenkatalog(QDialog, Ui_Dialog_Themenkatalog):
    ...
    def on_pB_Report_clicked(self):
        ...
        try:
            db = Database.get_instance(self)
            db.writeSQLite("kat_lap_themenkatalog")
    ...
    def tW_Db_Themenkatalog_Anzeigen(self,  filter1 = "",  filter2 = ""):
        ...
        self.tW_Db_Themenkatalog.setColumnCount(10)
        ...
        self.tW_Db_Themenkatalog.setHorizontalHeaderItem(9, colname)
        ...
        if filter2 == "Alle Anzeigne":
            filter2 = ""
        if filter2 != "":
            sql =  "select * from KAT_lap_themenkatalog WHERE "+ filter1 +" = '" + filter2 + "'"
        else:
