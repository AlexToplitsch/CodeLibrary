...
class GuiApprenticeAdd(QDialog, Ui_ApprenticeAdd):
    ...
    def on_pushButton_hinzufuegen_clicked(self):
        ...
        if len(errors) < 1:
            ...
            sql = "INSERT INTO kat_list (Personalnummer,Vorname,Nachname,Geburtsdatum,Geschlecht,Lehrberuf,Hauptmodul,Spezialmodul,Lehrbeginn,Lehrdauer,Mail,Telefonnummer,Strasse,Hausnummer,PLZ,ORT,LKZ) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
