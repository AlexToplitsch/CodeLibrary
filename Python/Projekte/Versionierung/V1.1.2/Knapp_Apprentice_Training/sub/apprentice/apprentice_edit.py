...
class GuiApprenticeEdit(QDialog, Ui_ApprenticeEdit):
    ...
    def db_auslesen(self):
        ...
        sql = "SELECT * FROM apprentice_list WHERE Personalnummer = '"+ self.personalnummerweitergabe +"'"
    ...
    def on_pushButton_speichern_clicked(self):
        ...
        if len(errors) < 1:
            ...
            sql = "REPLACE INTO kat_list (Personalnummer,Vorname,Nachname,Geburtsdatum,Geschlecht,Lehrberuf,Hauptmodul,Spezialmodul,Lehrbeginn,Lehrdauer,Mail,Telefonnummer,Strasse,Hausnummer,PLZ,ORT,LKZ) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
