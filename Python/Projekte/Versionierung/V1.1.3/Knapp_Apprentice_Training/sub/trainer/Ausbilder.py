...
class Ausbilder(QDialog, Ui_Ausbilder):
    ...
    def on_pb_report_clicked(self):
        ...
        input_file = 'Reports/kat_ausbilder.jrxml'
        output = 'Reports/kat_ausbilder' # Ziel-/SUB-Ordner
        #output = 'Excel\Verzeichnis'
        con = {'driver':'generic',
        ...
        #subprocess.Popen ("Excel\Verzeichnis.pdf",  shell=True)
