...
class Fachrichtungen(QDialog, Ui_Fachrichtungen):
    ...
    def twAnzeigen(self):
        ...
        self.twAnzeige.setColumnCount(6)
        ...
        self.twAnzeige.setHorizontalHeaderItem(5,  colname)
        self.twAnzeige.setRowCount(1)
        
        sql = "SELECT id, fachrichtung, bezeichnung, lehrjahre, benutzername, aenderungsdatum  FROM kat_fachrichtungen"
    ...
    def on_twAnzeige_cellClicked(self, row, column):
        """
        """
        self.leFachrichtungabk.setText(self.twAnzeige.item(row,  1).text())
        self.leFachrichtungbez.setText(self.twAnzeige.item(row,  2).text())
        Lehrjahre = float(self.twAnzeige.item(row,  3).text())
        self.sbLehrjahre.setValue(Lehrjahre)
