...
class Fachabteilungen(QDialog, Ui_Fachabteilungen):
    ...
    def on_btSpeichern_clicked(self):
        ...
        if self.leFachabteilungabk.text() == "":
            ...
            if satz_len == 0:
                ...
                val = (self.leFachabteilungabk.text(), self.leFachabteilungbez.text(), self.leGebaeude.text(), self.leStock.text(), self.leAbteilungsleitername.text(), self.leAbteilungsleiteremail.text(), self.leAbteilungsleitertel.text(),  self.leAnsprechspersonname.text(), self.leAnsprechspersonemail.text(), self.leAnsprechspersontel.text(), self.cbMo.isChecked(), self.cbDi.isChecked(), self.cbMi.isChecked(),  self.cbDo.isChecked(), self.cbFr.isChecked(), self.parent().label_eingeloggt_als.text())
    ...
    def on_tableWidget_cellClicked(self, row, column):
        ...
        self.leAbteilungsleiteremail.setText(self.tableWidget.item(row, 5).text())
        self.leAbteilungsleitertel.setText(self.tableWidget.item(row, 6).text())
        ...
        self.leAnsprechspersonemail.setText(self.tableWidget.item(row, 9).text())
    ...
    def on_btClear_clicked(self):
        ...
        self.leAbteilungsleiteremail.setText("")
        self.leAbteilungsleitertel.setText("")
        self.leAnsprechspersonname.setText("")
        self.leAnsprechspersonemail.setText("")
    ...
    def on_btExcel_clicked(self):
        ...
        """
        self.INFO("Excel-Funktion wird noch hinzugefügt!",  "I")
