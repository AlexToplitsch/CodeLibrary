...
# Form implementation generated from reading ui file 'D:\projects\Python\V1.7\Knapp_Apprentice_Training\sub\departments\Fachabteilung.ui'
#
...
class Ui_Fachabteilungen(object):
    def setupUi(self, Fachabteilungen):
        ...
        self.btAbbrechen.setGeometry(QtCore.QRect(391, 280, 121, 30))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.btAbbrechen.setMaximumSize(QtCore.QSize(135, 16777215))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.btExcel.setGeometry(QtCore.QRect(513, 280, 82, 30))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.btSuchen.setGeometry(QtCore.QRect(1, 280, 91, 30))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.btLoeschen.setGeometry(QtCore.QRect(298, 280, 91, 30))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.btClear.setGeometry(QtCore.QRect(94, 280, 85, 30))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.btHilfe.setGeometry(QtCore.QRect(692, 280, 81, 30))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        font = QtGui.QFont()
        font.setPointSize(10)
        self.gbWochentage.setFont(font)
        ...
        font = QtGui.QFont()
        font.setPointSize(10)
        self.gbAnsprechsperson.setFont(font)
        self.gbAnsprechsperson.setObjectName("gbAnsprechsperson")
        self.leAnsprechspersonmail = QtWidgets.QLineEdit(self.gbAnsprechsperson)
        self.leAnsprechspersonmail.setGeometry(QtCore.QRect(130, 90, 231, 22))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.leAnsprechspersonmail.setFont(font)
        self.leAnsprechspersonmail.setObjectName("leAnsprechspersonmail")
        self.lblAnsprechspersonname = QtWidgets.QLabel(self.gbAnsprechsperson)
        self.lblAnsprechspersonname.setGeometry(QtCore.QRect(58, 32, 81, 20))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.lblAnsprechspersonname.setFont(font)
        ...
        font = QtGui.QFont()
        font.setPointSize(10)
        self.gbAbteilungsleiter.setFont(font)
        self.gbAbteilungsleiter.setObjectName("gbAbteilungsleiter")
        self.leAbteilungsleitermail = QtWidgets.QLineEdit(self.gbAbteilungsleiter)
        self.leAbteilungsleitermail.setGeometry(QtCore.QRect(130, 90, 231, 22))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.leAbteilungsleitermail.setFont(font)
        self.leAbteilungsleitermail.setObjectName("leAbteilungsleitermail")
        self.lblAlTelnr = QtWidgets.QLabel(self.gbAbteilungsleiter)
        self.lblAlTelnr.setGeometry(QtCore.QRect(55, 60, 81, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.lblAlTelnr.setFont(font)
        self.lblAlTelnr.setObjectName("lblAlTelnr")
        self.leAbteilungsleitertel = QtWidgets.QLineEdit(self.gbAbteilungsleiter)
        self.leAbteilungsleitertel.setGeometry(QtCore.QRect(130, 60, 181, 22))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.leAbteilungsleitertel.setFont(font)
        ...
        self.lblAbteilungsleitername.setGeometry(QtCore.QRect(58, 31, 71, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.lblAbteilungsleitername.setFont(font)
        ...
        self.lblAlEmail.setGeometry(QtCore.QRect(55, 90, 81, 20))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.lblAlEmail.setFont(font)
        ...
        font = QtGui.QFont()
        font.setPointSize(10)
        self.leAbteilungsleitername.setFont(font)
        ...
        Fachabteilungen.setTabOrder(self.leAbteilungsleitername, self.leAbteilungsleitertel)
        Fachabteilungen.setTabOrder(self.leAbteilungsleitertel, self.leAbteilungsleitermail)
        Fachabteilungen.setTabOrder(self.leAbteilungsleitermail, self.leAnsprechspersonname)
        Fachabteilungen.setTabOrder(self.leAnsprechspersonname, self.leAnsprechspersontel)
        Fachabteilungen.setTabOrder(self.leAnsprechspersontel, self.leAnsprechspersonmail)
        Fachabteilungen.setTabOrder(self.leAnsprechspersonmail, self.btSuchen)
