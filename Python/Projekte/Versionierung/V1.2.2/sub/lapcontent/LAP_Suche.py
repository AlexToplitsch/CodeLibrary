...
class LAP_Themenkatalog_Suche(QDialog, Ui_LAP_Themenkatalog_Suche):
    ...
    def on_tW_LAP_Themenkatalog_DB_cellClicked(self, row, column):
        ...
        try:
            ...
            self.parent().le_lehrjahr.setText(self.tW_LAP_Themenkatalog_DB.item(row, 5).text())
            self.parent().le_bs_jahr.setText(self.tW_LAP_Themenkatalog_DB.item(row, 6).text())
        except Exception:
