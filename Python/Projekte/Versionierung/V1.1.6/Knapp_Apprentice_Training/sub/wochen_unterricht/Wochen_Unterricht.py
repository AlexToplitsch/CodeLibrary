...
#        print(d1)
        self.kalenderwoche(int(d1), int(self.te_KW.text()))
...
#        print(grid)
    ...
    def on_pushButton_befor_KW_clicked(self):
        ...
        self.kalenderwoche(name, before)
# TODO: not implemented yet
        #raise NotImplementedError

    def kalenderwoche(self,  year, kw):
        first_monday = 4 - datetime.date(int(year),1,4).weekday()
        monday_of_kw = first_monday + (kw - 1)*7
        
        print(monday_of_kw, monday_of_kw + 7)
        Montag = monday_of_kw
        Dienstag = monday_of_kw +1
        Mittwoch = monday_of_kw+2
        Donnerstag = monday_of_kw+3
        Freitag = monday_of_kw+4
        
        
        self.label_Montag.setText(str(Montag))
        self.label_Dienstag.setText(str(Dienstag))
        self.label_Mittwoch.setText(str(Mittwoch))
        self.label_Donnerstag.setText(str(Donnerstag))
        self.label_Freitag.setText(str(Freitag))
