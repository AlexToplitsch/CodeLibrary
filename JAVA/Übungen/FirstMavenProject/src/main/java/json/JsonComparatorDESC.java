...
public class JsonComparatorDESC implements Comparator<ValueObject> {

    /**
     * Compares the name attribute of two instances of the ValueObject and returns the
     * difference between the names in reversed alphabetical order
     * @param o1 First instance of the Value object
     * @param o2 Second instance of the Value object
     * @return int: The gap between the the names in reversed alphabetical order
     */
    @Override
