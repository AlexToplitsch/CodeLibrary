...
public class SorterTestCase {
    ...
    Sorter sorter = new Sorter(case1.clone(), true);
    ...
    public void ascSortFirstPivot1(){
        sorter.setIntArr(case1.clone());
        int[] res = sorter.sort(false);
